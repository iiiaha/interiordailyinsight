...
- 제품이 뜨고 있다면 → "고객 제안 시 이 제품을 포함하십시오", "이 제품 시공 역량을 확보하십시오"
- 소파/가구/가전이 뜨고 있다면 → "인테리어 제안 시 이 제품과 어울리는 공간 연출을 제안하십시오", "이 제품을 배치할 수 있는 설계를 고려하십시오"
- 절대로 해당 제품의 제조사/판매사에게 하는 조언을 쓰지 마십시오.

톤: 전문 컨설턴트 격식 존댓말. "~하십시오", "~권장합니다".
...
{{
  ...
  "section3_price_intel": {{
    "title": "오늘의 가격 인텔리전스",
    "price_data": [{{"scope": "공사범위 (예: 34평 턴키)", "price": "구체적 금액 필수 (예: 4,500만원). '문의 다수' 같은 표현 금지. 금액을 모르면 이 항목 제외.", "includes": "포함항목", "action": "인테리어 시공업체가 이 가격 정보를 어떻게 활용할지 2~3문장."}}]
  }},
